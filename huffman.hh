...
class Huffman {
 ...
 private:
  HForest* hf_;
  uint64_t freq_table_[ALPHABET_SIZE] = {0};
  // decode could work without cur_tree_, but it would be a lot uglier
  HForest::tree_ptr_t cur_tree_;
  // helper function
  void create_tree();
};

// helper function converts direction vector to boolean vector
